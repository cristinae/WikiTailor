...
public class LanguageConstantsTest {
	...
	public void testGetCategoryLabel() {
		...
		Assert.assertArrayEquals(new String[] {"categorie", "categoria"}, constants.getCategoryLabel(Language.italian));
	...
	public void testGetSeeAlsoLabel() {
		...
		Assert.assertArrayEquals(new String[] {"vedere anche"}, constants.getSeeAlsoLabel(Language.italian));
	...
	public void testGetReferencesLabel() {
		...
		Assert.assertArrayEquals(new String[] {"riferimenti"}, constants.getReferencesLabel(Language.italian));
