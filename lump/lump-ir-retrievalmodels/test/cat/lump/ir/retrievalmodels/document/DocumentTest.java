...
public class DocumentTest {
	...
	public void testGetBow(){
		...
		//TODO do the assert on the basis of the contents instead of the entire list
		
		//TODO THERE IS A PROBLEM WITH SPACES AND BLANCKS HERE!!!!
		//THE TESTS ARE NOT PASSED BECAUSE OF THAT. CHECK IT
		Assert.assertEquals(expected, doc.get(RepresentationType.BOW));
	}
	...
	public void testGetFragmentBow(){
		...
		//TODO do the assert on the basis of the contents instead of the entire list
		Assert.assertEquals(expected, doc.getFragment(2).get(RepresentationType.BOW));
	}
	...
	public void testGetCng(){
		...
		for (String x : doc.get(RepresentationType.CNG))
			System.out.println(x);
		
		//TODO do the assert on the basis of the contents instead of the entire list
		Assert.assertEquals(expected, doc.get(RepresentationType.CNG));
	}
...
//		+ "llamados \"La mejor banda prog-rock\" del 2008 por Rolling Stone.";
		...
		Assert.assertEquals(expected, doc.get(RepresentationType.WNG));	
		}
