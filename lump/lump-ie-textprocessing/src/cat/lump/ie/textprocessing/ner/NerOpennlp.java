...
public class NerOpennlp implements Decomposition{
	...
	private static final String PERSON_EN = "models/en-ner-person.bin";
	
	private static final String PERSON_ES = "models/es-ner-person.bin";
...
//		
	...
	public static void main(String[] args){
		...
		String[] text = new String[]{//				
			"The",	"Liberal",	"Party",	"led",	"by",	"Will",	"Hodgman",	"have",	"won",	"government",	"in",	"the",	"Tasmanian",	"election"
